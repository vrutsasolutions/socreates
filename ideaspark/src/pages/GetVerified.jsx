  ...
  return (
    <div className="min-h-screen bg-[#F4F7FF] flex flex-col">
      ...
      <div className="bg-[#1565C0] ">
        <div className="bg-white rounded-t-[32px] flex flex-col items-center text-center px-6 pt-10 pb-10">

          {/* Badge icon */}
          <div className="w-20 h-20 rounded-full bg-[#E3F2FD] flex items-center justify-center mb-6">
            <div className="w-16 h-16 rounded-full bg-[#1565C0] flex items-center justify-center shadow-md">
              <svg className="w-8 h-8 text-[#ffffff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
          ...
          <div className="w-full pt-8 pb-2 space-y-3">
            ...
            <button
              ...
              className="w-full text-[#546E7A] font-semibold py-3 text-sm"
            >
              Skip for now
            </button>
