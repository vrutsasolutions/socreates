...
export default function Settings() {
  ...
  const Row = ({ icon, label, sublabel, right, onClick, danger }) => (
    <div onClick={onClick} className={`flex items-center gap-3 px-4 py-4 border-b border-[#BBDEFB] last:border-0
  ...
  return (
    <div className="min-h-screen bg-white pb-10">
      ...
      <div className="bg-[#1565C0]">
        <div className="flex items-center gap-4 px-4 py-5 mb-5 bg-[#1565C0]">
          ...
          <button onClick={() => navigate('/edit-profile')} className="text-white text-xs font-medium border border-blue-300/40 px-3 py-1.5 rounded-xl hover:bg-white/10 transition">
            Edit
          </button>
        </div>

        <div className="bg-white rounded-t-3xl pt-5 px-0">
          {/* Account */}
          ...
          <p className="text-center text-[#BBDEFB] text-xs pb-6">IdeaSpark v1.0.0</p>
        </div>
      </div>
    </div>
  );
