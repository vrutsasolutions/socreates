    ...
    <div className="min-h-screen bg-[#F4F7FF] pb-24 overflow-x-hidden">
      ...
      <div className="bg-[#1565C0]">
        <div className="bg-white rounded-t-[32px] px-4 pt-4">
          ...
          <div>
            {loading ? (
              <div className="grid grid-cols-2 gap-3">{Array(4).fill(0).map((_,i) => <div key={i} className="bg-[#F0F6FF] rounded-2xl overflow-hidden animate-pulse"><div className="h-32 bg-[#BBDEFB]"/><div className="p-3 space-y-2"><div className="h-3 bg-[#BBDEFB] rounded w-3/4"/><div className="h-2.5 bg-[#BBDEFB] rounded"/></div></div>)}</div>
            ) : ideas.length > 0 ? (
